          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="text-xl font-bold text-slate-900">
                AI Ассистент по ВУЗам
              </h3>
              <p className="text-slate-600 mt-1">
                Спросите о университетах, программах, общежитиях или получите
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-2xl font-bold text-slate-900">
                  Google Maps карта университетов
                </h3>
                <p className="text-slate-600 mt-2">
                  Нажмите чтобы открыть интерактивную карту с реальными
                  координатами университетов Казахстана
                </p>
              </div>
            </div>
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center p-4">
              <div className="text-center text-white">
                ...
                <div className="text-sm text-blue-200">
                  Реальные координаты университетов
                </div>
              </div>
              ...
              {[
                {
                  ...
                  label: "Навигация",
                  desc: "Zoom и панорамирование",
                },
                {
                  icon: <Filter className="h-4 w-4" />,
                  label: "Фильтры",
                  desc: "По типу и городу",
                },
                {
                  icon: <Search className="h-4 w-4" />,
                  label: "Поиск",
                  desc: "Университеты и города",
                },
                {
                  icon: <GraduationCap className="h-4 w-4" />,
                  label: "Инфо",
                  desc: "Детальная информация",
                },
              ].map((feature, idx) => (
                <div
                  key={idx}
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="text-left">
              ...
              <p className="text-slate-600">
                Подробный анализ по регионам и типам ВУЗов
              </p>
            </div>
          </div>
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <div className="font-semibold text-slate-800">
                            {item.students} студентов
                          </div>
                          <div className="text-sm text-slate-600">
                            {item.programs} программ
                          </div>
                        </div>
                      </div>
                      <div className="text-right">
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <Card className="p-6 h-full">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h3 className="text-xl font-bold text-slate-900">
                Топ университетов Казахстана
              </h3>
              <p className="text-slate-500 text-sm">
                По рейтингу 2024 года • Нажмите для просмотра на карте
              </p>
            </div>
          </div>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-slate-500">
                      {uni.city} • {uni.students} студентов
                    </div>
                  </div>
                </div>
                <div className="text-right">
        ...
        <Card className="p-6 h-full">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-slate-500 text-sm">
                Персональный подбор ВУЗа на основе ваших данных
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="p-4 rounded-xl bg-gradient-to-r from-purple-50 to-pink-50 border border-purple-100 hover:border-purple-200 transition-all">
              ...
              <div className="text-sm text-slate-600 mb-3">
                Скажите свои баллы ЕНТ и интересы для персонализированного
                подбора
              </div>
              <button
                onClick={() =>
            ...
            <div className="p-4 rounded-xl bg-gradient-to-r from-blue-50 to-cyan-50 border border-blue-100 hover:border-blue-200 transition-all">
              ...
              <div className="text-sm text-slate-600 mb-3">
                Найдите лучшие программы по выбранной специальности в разных
                городах
              </div>
              <button
                onClick={() =>
                  navigate("/ai-chat", {
                    state: {
                      initialMessage: "Какие есть программы по информатике?",
                    },
                  })
                }
          ...
          <div className="mt-6 pt-6 border-t border-slate-100">
            <h4 className="font-semibold text-slate-900 mb-3">
              Популярные вопросы к AI ассистенту
            </h4>
